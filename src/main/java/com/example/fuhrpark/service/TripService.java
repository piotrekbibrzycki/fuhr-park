...
public class TripService {
    ...
    public TripResponseDto createTrip(TripRequestDto tripRequestDto) {
        Truck truck = truckRepository.findById(tripRequestDto.truckId()).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Ciężarówka o podanym ID nie istnieje."));
        Driver driver = driverRepository.findById(tripRequestDto.driverId()).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Kierowca o podanym ID nie istnieje."));
    ...
    public TripResponseDto updateTrip(UUID id, TripRequestDto tripRequestDto) {
        Trip trip = tripRepository.findById(id).orElseThrow(()-> new ResponseStatusException(HttpStatus.NOT_FOUND, "Trasa o podanym ID nie istnieje"));
        Truck truck = truckRepository.findById(tripRequestDto.truckId()).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Ciężarówka o podanym ID nie istnieje"));
        Driver driver = driverRepository.findById(tripRequestDto.driverId()).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Kierowca o podanym ID nie istnieje"));
